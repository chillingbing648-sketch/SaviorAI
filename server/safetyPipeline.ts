...
*Notice: This summary is generated by Mendly for medical communication and triage safety reference only.*`;
...
export async function executeSafetyTriagePipeline(
  ...
  try {
    ...
    const promptText = `
You are Mendly's Clinical Safety & Triage Orchestrator.
...
`;
    ...
    const aiResponse = await gemini.models.generateContent({
      ...
      config: {
        systemInstruction: `You are the Mendly safety triage system. You must prioritize patient safety over everything else. Never make definitive medical diagnoses. Emphasize observation, possibility, risk, and immediate safe action. Return valid JSON only.`,
